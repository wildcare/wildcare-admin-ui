...
const Avistamientos: React.FC = () => {
	...
	const filteredItems = useMemo(() => {
		...
		if (hasSearchFilter) {
			filteredAvistamientos = filteredAvistamientos.filter((avistamiento) =>
				avistamiento[selectedValue as keyof Avistamiento]
					.toString()
					.toLowerCase()
	...
	const sortedItems = React.useMemo(() => {
		return [...filteredItems].sort((a: Avistamiento, b: Avistamiento) => {
			const first = a[sortDescriptor.column as keyof Avistamiento] as
				| string
				| number
			const second = b[sortDescriptor.column as keyof Avistamiento] as
				| string
				| number
